...
Theme: **Finding peace when the future feels uncertain**
...
8. Export 1080p H.264, verify duration is at most 3:00, and watch it end to end.

## If something fails

- Never fake the API label over a mocked response.
- Use a previously captured continuous take of the real request.
